...
export default function Perijinan({navigation,route}) {
    useEffect(() => {
        ...
        <View style={styles.row}>
            <TouchableOpacity style={[styles.card , {backgroundColor:'#fff'} ]}>
                ...
                <View style={styles.cardContent}>
                    <Text style={styles.name}>{'Ijin Sakit'}</Text>
                    <TouchableOpacity style={styles.followButton} onPress={()=> navigation.navigate('Input Sakit' , {
