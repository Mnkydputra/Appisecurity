...
export default function Approve({navigation, route}) {
    ...
    const daftarLembur = () => {
        var urlAksi = 'https://isecuritydaihatsu.com/api/daftarLembur?wilayah=' + route.params.wilayah + '&jabatan=' + route.params.jabatan
        // var urlAksi = 'http://192.168.8.170/isecurity_ea/api/daftarLembur?wilayah=wil2&jabatan=PIC'
        fetch(urlAksi,{
            headers : {
